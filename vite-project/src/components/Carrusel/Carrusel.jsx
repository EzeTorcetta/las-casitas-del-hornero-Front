      ...
      <div className={style.container}>
        <Carousel className={style.carousel}>
          <Carousel.Item className={style.item}>
            <img className={style.img} src="https://www.murhotels.com/cache/40/b3/40b3566310d686be665d9775f59ca9cd.jpg" alt="First slide" />
            <Carousel.Caption>
          ...
          <Carousel.Item className={style.item}>
            <img className={style.img} src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/01/ce/0c/66/frente-nocturno.jpg?w=700&h=-1&s=1" alt="Second slide" />
            <Carousel.Caption>
